...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'wasm_test_bin-b760841e1d1dd7cc.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'wasm_test_bin-b760841e1d1dd7cc.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'wasm_test_bin-b760841e1d1dd7cc.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "wasm_test_bin-b760841e1d1dd7cc.js.mem" : null;




var STATIC_BUMP = 3040;
...
var real__rust_begin_unwind = asm["_rust_begin_unwind"]; asm["_rust_begin_unwind"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
return real__rust_begin_unwind.apply(null, arguments);
};
...
var _rust_begin_unwind = Module["_rust_begin_unwind"] = function() { return Module["asm"]["_rust_begin_unwind"].apply(null, arguments) };
...
//# sourceMappingURL=wasm_test_bin-b760841e1d1dd7cc.js.map